...
ARTIFACT_NAME_PREFIX = "touhou-little-maid-mahjong-"
...
def is_build_relevant_path(path: str) -> bool:
    ...
    # Resources are build inputs even when their extension is Markdown. This
    # includes both the distributed mod and game-test source sets.
    if re.match(r"src/[^/]+/resources/", normalized):
        return True
...
def fetch_latest_artifact(
    ...
    for page in range(1, MAX_ARTIFACT_PAGES + 1):
        ...
        headers = {
            ...
            "User-Agent": "TouhouLittleMaid-Mahjong-build-decision",
